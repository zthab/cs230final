 ...
 * </br> Methods include a method for each panel of the game which creates that panel, randomize() which takes the 
 * situational commands that the user must memorize and randomly puts them into memQueue, and a toString for memeQueue.
 * Two private classes are created, one for each action listener. One is for the JTextField which the user inputs
 * answers into and the other is for the variouse buttons. 
 *
 * Known bugs/details: 
...
public class MemoryPanel extends JPanel {
    ...
    protected JLayeredPane content;//holds two panels one of which is the background image
    ...
    public MemoryPanel(String name){//call the senario, a string in circumstance
        ...
        content = new JLayeredPane();//olds a background images and a panel on top
        background = new JPanel();//holds the scenario image
        deck = new JPanel(new CardLayout());//container for the panels, switches between them like playingcards
    ...
    protected class UserListener implements ActionListener {
        /**
         * Takes the user input and checks it with the correct answer by comparing it to the current item dequeued from memQueue.
         * If the answer is correct, the user may continue until all the answers have been inputted. If the answer is incorrect,
        ...
        public void actionPerformed (ActionEvent event) {      
            ...
            count++;
            //if word doesn't match the top of the queue, game over. If it does, just keep playing
            if (!input.equals(memQueue.dequeue())){
                //switch panels to a game over panel
                cl.show(deck, "loser");
            }
            //if the queue gets empty, it means all the words matched and they won
            if (memQueue.size()==0)
                cl.show(deck, "winner");
        }
    }
    ...
    protected class ButtonListener implements ActionListener {
        /**
         * Depending on which button is selected, a different action occures. All of these buttons are screen transitions
         */
        public void actionPerformed(ActionEvent event){
    ...
    public void randomize(){
        ...
        while (memQueue.size()<listLength){//until the memQueue is full
            ...
            if (answerKey.indexOf(wordList[index][n])==-1){//if it isn't already in the answerKey
    ...
    /**
     * Third scenario sceen- Where the user plays the game by inputting words into a text field
     * 
    ...
    /**
     * One of two possible final scenario sceen, appears if the user does not input the correct word
     * 
    ...
    /**
     * One of two possible final scenario sceen, appears if the user inputs all the correct words
     * 
